<div class="d-flex flex-column" style="width: 220px; flex-shrink: 0; min-height: 100vh; background-color: #FBE3EC;">
    ...
    <ul class="nav flex-column p-2 gap-1">
        ...
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2 px-3 py-2"
                style="color: #4A3F3F; border-radius: 8px; {{ request()->routeIs('admin.ordermanagements.*') ? 'background-color: #FFFFFF; font-weight: 600;' : '' }}"
        ...
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center gap-2 px-3 py-2"
                style="color: #4A3F3F; border-radius: 8px; {{ request()->routeIs('admin.reviewmanagements.*') ? 'background-color: #FFFFFF; font-weight: 600;' : '' }}"
