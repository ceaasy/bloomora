        ...
        <div class="row g-4">
            ...
            <div class="col-md-7">
                ...
                <div class="d-flex gap-2 mb-4">
                    <button type="button" class="btn size-option rounded-3 flex-fill"
                        data-price="{{ $product->price_small }}" style="border: 1px solid #D6336C; color: #4A3F3F;">
                    ...
                    <div class="mb-4">
                        @foreach ($product->customization_options as $option)
                            <div class="form-check mb-1">
                                <input class="form-check-input" type="checkbox" id="custom_{{ $loop->index }}">
                ...
                <div class="d-flex align-items-center gap-2 mb-4">
                    ...
                    <span id="jumlahProduk">1</span>
                    <button type="button" class="btn btn-sm" style="border: 1px solid #D6336C;"
                        onclick="ubahJumlah(1)">+</button>
                </div>

                <div class="d-flex gap-2">
                    <a href="#" class="btn rounded-pill flex-fill py-2" style="background-color: #D6336C; color: white;">
                        Checkout
                    </a>
                    <a href="#" class="btn rounded-pill flex-fill py-2" style="border: 1px solid #B96F84; color: #B96F84;">
                        + Keranjang
                    </a>
                </div>
            </div>
