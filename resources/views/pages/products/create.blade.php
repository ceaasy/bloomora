...
@section('title', 'Create New - Product Page')
@section('page-title', 'PRODUCT PAGE')

@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Create New - Product page</h1>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="category" id="category"
                                ...
                                <option value="Buket" {{ old('category') == 'Buket' ? 'selected' : '' }}>Buket</option>
                                <option value="Hampers" {{ old('category') == 'Hampers' ? 'selected' : '' }}>Hampers
                                </option>
                            </select>
                        ...
                        <div id="customization-wrapper">
                            @if (old('customization_name'))
                                @foreach (old('customization_name') as $i => $name)
                                    <div class="row mb-2 customization-row">
                                        <div class="col-md-6">
                                            <input type="text" name="customization_name[]"
                                                value="{{ $name }}" class="form-control"
                                                placeholder="Nama kustomisasi">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="number" step="0.01" name="customization_price[]"
                                                value="{{ old('customization_price')[$i] ?? '' }}" class="form-control"
